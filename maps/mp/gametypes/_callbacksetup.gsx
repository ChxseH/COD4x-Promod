...
CodeCallback_StartGameType()
{
	...
	{
		thread scripts\main::init(); //to set some initial stats & dvars
...
/*================
Called when a script defined command has been invoked.
================*/
CodeCallback_ScriptCommand(command, arguments)
{
	self thread scripts\scriptcommands::commandHandler( command, arguments ); // ingame Commands ($fov, $fps)
}
//=============================================================================